{{-- resources/views/petugas/pengiriman/index.blade.php --}}
...
<div class="container-fluid">
    ...
    <div class="filter-card-modern" data-aos="fade-up">
        <form method="GET" action="{{ route('petugas.pengiriman.index') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Alamat">
                            <div>{{ Str::limit($transaksi->alamat_lengkap, 50) }}</div>
                            <small class="text-muted">{{ $transaksi->kelurahan }}, {{ $transaksi->kecamatan }}</small>
                        </td>
                        <td class="fw-bold text-success" data-label="Deposit">Rp {{ number_format($transaksi->jumlah_deposit, 0, ',', '.') }}</td>
                        <td data-label="Tanggal">{{ $transaksi->created_at->translatedFormat('d M Y') }}</td>
                        <td data-label="Aksi">
